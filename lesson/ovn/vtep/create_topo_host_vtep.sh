...
vtep-ctl add-ps br0
vtep-ctl set Physical_Switch br0 tunnel_ips=192.168.220.17
...
ovs-vsctl set open . external-ids:ovn-remote=tcp:192.168.220.23:6642
ovs-vsctl set open . external-ids:ovn-encap-type=vxlan
ovs-vsctl set open . external-ids:ovn-encap-ip=192.168.220.17
ovn-controller-vtep -vconsole:emer -vfile:info --log-file=/var/log/openvswitch/ovn-controller-vtep.log --vtep-db=unix:/var/run/openvswitch/db.sock --ovnsb-db=tcp:192.168.220.23:6642 --detach --monitor 
vtep-ctl add-ls ls0
