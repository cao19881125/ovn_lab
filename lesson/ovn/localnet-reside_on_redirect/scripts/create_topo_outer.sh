...
ovs-vsctl add-port br-ext1 eth0
...
ovs-vsctl add-port br1 test -- set interface test type=internal
ip link set test address 02:ac:10:ff:01:07
ip netns add test
ip link set test netns bm1
